...
export const menu: MenuCategory[] = [
    ...
    groups: [
      {
        ...
        items: [
          { id: "omelette-simple", name: "Omelette simple", nameEn: "Plain omelette", price: 3000 },
          { id: "omelette-garnie", name: "Omelette garnie", nameEn: "Garnished omelette", price: 3500 },
          ...
          { id: "avocat-crevettes", name: "Avocat crevettes", nameEn: "Shrimps avocado", description: "Avocat, crevettes, tomate, oignon, œuf dur", price: 5500 },
        ],
      },
      {
    ...
    groups: [
      {
        items: [
          ...
          { id: "ndole-royal", name: "Ndolè royal", nameEn: "Royal Ndolè", description: "Pour la table entière", price: 15000, image: "/images/couscous-ndole.jpg", featured: true },
        ],
      },
    ],
  },
    ...
    groups: [
      {
        ...
        items: [
          ...
          { id: "jb-bouteille", name: "J&B (bouteille)", price: 25000 },
          ...
          { id: "red-label-bouteille", name: "Red Label (bouteille)", price: 25000 },
          { id: "clan-campbell-verre", name: "Clan Campbell (verre)", price: 2000 },
          { id: "clan-campbell-bouteille", name: "Clan Campbell (bouteille)", price: 25000 },
      ...
      },
      {
        ...
        items: [
          ...
          { id: "rhum-saint-james-bouteille", name: "Rhum Saint James (bouteille)", price: 25000 },
  ...
  },
  {
    ...
    groups: [
      {
        items: [
          { id: "pina-colada", name: "Piña Colada", description: "Crème coco · lait coco · ananas · crème fraîche · rhum blanc · Malibu", price: 5000, image: "/images/cocktail-1.jpg", featured: true },
          { id: "caresse", name: "Caresse", description: "Jus d'orange · jus d'ananas · jus de citron · sucre de canne · sirop grenadine", price: 5000 },
          { id: "blue-lagoon", name: "Blue Lagoon", description: "Vodka · blue curaçao · citron · limonade", price: 5000 },
          { id: "colada-fraise", name: "Colada Fraise", description: "Lait coco · crème coco · sucre de canne · sirop fraise", price: 5000 },
          { id: "mojito", name: "Mojito", description: "Rhum blanc · sucre · soda · menthe", price: 5000, image: "/images/cocktail-2.jpg", featured: true },
          { id: "cuba-libre", name: "Cuba Libre", description: "Rhum brun · jus de citron · coca", price: 5000, image: "/images/cocktail-3.jpg", featured: true },
          { id: "tequila-sunrise", name: "Tequila sunrise", price: 5000 },
          { id: "gin-fizz", name: "Gin fizz", price: 5000 },
          { id: "americano", name: "Americano", price: 5000 },
          { id: "tequila-paf", name: "Tequila paf", price: 5000 },
          { id: "diabolo", name: "Diabolo", price: 2500 },
          { id: "menthe-lait-cocktail", name: "Menthe lait", price: 2000 },
        ],
      },
    ],
  },
