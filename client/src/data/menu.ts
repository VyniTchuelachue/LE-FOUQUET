    ...
    groups: [
      {
        ...
        items: [
          ...
          { id: "poulet-poele", name: "Poulet poêlé", nameEn: "Fried chicken", price: 5500, priceLabel: "5 500 / 10 000", image: "/images/poulet-poele.jpg", featured: true },
          { id: "poulet-sauce-forestiere", name: "Poulet sauce forestière", nameEn: "Chicken in mushroom sauce", price: 5000, image: "/images/poulet-sauce-forestiere.jpg", featured: true },
          { id: "poulet-sauce-creme", name: "Poulet sauce crème", nameEn: "Chicken in cream sauce", price: 4500, image: "/images/poulet-sauce-creme.jpg", featured: true },
          { id: "poulet-basquaise", name: "Poulet basquaise", nameEn: "Basquaise chicken", price: 3500, image: "/images/poulet-basquaise.jpg", featured: true },
        ],
      },
      {
        label: "Pâtes & Riz",
        items: [
          ...
          { id: "riz-saute-villageois", name: "Riz sauté villageois", nameEn: "Village-style fried rice", price: 5000 },
          { id: "riz-saute-porc", name: "Riz sauté porc", nameEn: "Fried rice with pork", price: 5000 },
          ...
          { id: "riz-saute-crevettes", name: "Riz sauté crevettes", nameEn: "Fried rice with shrimps", price: 7000 },
        ],
      },
      {
        label: "Spécialités au Porc",
        items: [
          { id: "porc-grille", name: "Porc grillé", nameEn: "Grilled pork", price: 3000, image: "/images/porc-grille.jpg", featured: true },
          { id: "porc-basquaise", name: "Porc basquaise", nameEn: "Basquaise pork", price: 3500, image: "/images/porc-basquaise.jpg", featured: true },
          { id: "porc-creole", name: "Porc créole", nameEn: "Creole pork", price: 3500, image: "/images/porc-creole.jpg", featured: true },
          { id: "porc-poele", name: "Porc poêlé", nameEn: "Fried pork", price: 3500, image: "/images/porc-poele.jpg", featured: true },
          { id: "porc-saute-ail", name: "Porc sauté à l'ail", nameEn: "Garlic sautéed pork", price: 4000, image: "/images/porc-saute-ail.jpg", featured: true },
          { id: "roti-porc", name: "Rôti de porc", nameEn: "Roast pork", price: 3500, image: "/images/porc-roti-plantain.jpg", featured: true },
          { id: "porc-fume", name: "Porc fumé", nameEn: "Smoked pork", price: 4000, image: "/images/porc-fume.jpg", featured: true },
          { id: "porc-creme-champignons", name: "Porc crème champignons", nameEn: "Pork, cream & mushrooms", price: 5000, image: "/images/porc-creme-champignons.jpg", featured: true },
          ...
          { id: "porc-fume-creme", name: "Porc fumé crème", nameEn: "Smoked pork in cream", price: 5500, image: "/images/porc-fume-creme.jpg", featured: true },
          { id: "porc-fume-creme-champignons", name: "Porc fumé crème champignons", nameEn: "Smoked pork, cream & mushrooms", price: 6000, image: "/images/porc-fume-creme-champignons.jpg", featured: true },
        ],
      },
    ],
  },
    ...
    groups: [
      {
        items: [
          ...
          { id: "emince-boeuf", name: "Émincé de bœuf", nameEn: "Minced beef", price: 4500, image: "/images/emince-boeuf.jpg", featured: true },
          { id: "steak-grille", name: "Steak grillé", nameEn: "Grilled steak", price: 4500, image: "/images/steak-grille.jpg", featured: true },
          { id: "viande-creme", name: "Viande crème", nameEn: "Cream sauce with meat", price: 4500, image: "/images/viande-creme.jpg", featured: true },
          { id: "viande-basquaise", name: "Viande basquaise", nameEn: "Basquaise beef", price: 3000, image: "/images/viande-basquaise.jpg", featured: true },
    ...
    groups: [
      {
        items: [
          ...
          { id: "gambas-grillees", name: "Gambas grillées", nameEn: "Grilled prawns", price: 9000 },
    ...
    groups: [
      {
        items: [
          ...
          { id: "haricots-verts", name: "Haricots verts", nameEn: "Green beans", price: 1000 },
          { id: "riz-parfume", name: "Riz parfumé", nameEn: "Aromatic rice", price: 500 },
          { id: "riz-blanc", name: "Riz blanc", nameEn: "White rice", price: 500, image: "/images/riz-blanc.jpg", featured: true },
          { id: "riz-curry", name: "Riz curry", nameEn: "Curry rice", price: 500 },
          { id: "miondo", name: "Miondo", nameEn: "Cassava sticks", price: 500 },
          { id: "plantain-tape", name: "Plantain tapé", nameEn: "Smashed plantains", price: 500 },
          { id: "plantain-frit", name: "Plantain frit", nameEn: "Fried plantain", price: 500 },
          { id: "couscous-mais-manioc", name: "Couscous maïs et manioc", nameEn: "Cassava & corn fufu", price: 500 },
          { id: "frites", name: "Frites de pomme de terre", nameEn: "French fries", price: 500 },
    ...
    groups: [
      {
        ...
        items: [
          ...
          { id: "menthe-lait", name: "Menthe au lait", price: 2000 },
    ...
    groups: [
      ...
      },
      {
        ...
        items: [
          ...
          { id: "merlot", name: "Merlot", price: 25000 },
        ],
      },
      {
      ...
      },
      {
        ...
        items: [
          { id: "bois-royale-rouge", name: "Bois Royale rouge", price: 18000 },
          { id: "bois-royale-blanc", name: "Bois Royale blanc", price: 18000 },
          { id: "gasquet-rouge", name: "Gasquet rouge", price: 14000 },
          { id: "gasquet-blanc", name: "Gasquet blanc", price: 14000 },
        ],
      },
      {
        label: "Vins Mousseux",
        ...
        items: [
          {
            ...
            description: "Blanc & rouge moelleux — bouteille 12 000, verre 3 500",
            price: 12000,
            priceLabel: "12 000 (bout.) · 3 500 (verre)",
          },
          {
            id: "gasquet-verre",
            name: "Gasquet",
            description: "Rouge & blanc — bouteille 14 000, verre 4 000",
            price: 14000,
            priceLabel: "14 000 (bout.) · 4 000 (verre)",
          },
        ],
      },
    ],
